  ...
  <div class="min-h-full">
    <div class="py-3 pr-5 pb-6">
      <div class="flex flex-col gap-4 shadow px-4 py-4 rounded-lg">
        <h2 class="text-3xl font-bold text-center mb-4 text-[#545386]">Tickets del inventario</h2>
        <div class="flex items-center flex-nowrap border-2 border-base-content/20 rounded-lg px-0.5">
          <button
