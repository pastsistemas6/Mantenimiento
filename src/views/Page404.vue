    ...
    <div class="h-full">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355" class="w-full">
        <g id="ocean">
          ...
          <path id="water" fill="#D8D2C4" d="M0 200.7h1000V354H0z" />
        ...
        <g id="cloudsAll">
          <path
            id="cloud1"
            class="fill-white stroke-[#D8D2C4]"
        ...
        <g id="train">
          ...
          <g id="car-layers">
            ...
            />
            <image :href="logo" x="550" y="150" width="130" height="130" />
            ...
            <g id="ladders">
              ...
              <g id="ladder-b">
                <path id="ladder-back" class="fill-[#564D87]" d="M851.8 257.8h17.8v34.8h-17.8z" />
